...
|---|---|---|---|
| Core stack (excl. anti-debt) | ~156 078 | 105 | **Layered read** — cartography first, then targeted reads |
| Anti-debt agent | ~130 000 | 118 | Read its `AI_CONTEXT.md` and ADRs before its sources |
| Whole repo | ~285 727 | 223 | **Multi-phase workflow** — never a single direct read |
