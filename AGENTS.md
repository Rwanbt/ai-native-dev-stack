...
Measured 2026-09-07 (distribution & lifecycle v1, knowledge K1-K4) via `git ls-files` (image excluded). Re-measure
with `python3 scripts/measure_scope.py`; CI fails when these figures drift.

| Scope | Tokens (÷4) | Files | Strategy |
|---|---|---|---|
| Core stack (excl. anti-debt) | ~538 066 | 280 | **Layered read** — cartography first  then targeted reads |
