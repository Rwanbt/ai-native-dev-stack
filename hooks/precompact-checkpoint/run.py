"""Thin PreCompact adapter: shells out to the authoritative CLI. No policy here.
...
CLI_CALLS = [
    ["context", "checkpoint", "--state-json",
     '{"task": "pre-compact checkpoint", "open_work": ["restore after compaction"]}'],
]
