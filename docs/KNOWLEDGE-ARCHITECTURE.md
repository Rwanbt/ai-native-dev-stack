...
Any other transition is refused with `KNOWLEDGE_BAD_TRANSITION`. Multi-hop review moves (CLASSIFIED to SUPPORTED via
NEEDS_EVIDENCE) apply hop by hop with one audit event each. Version
